...
// const InputFile = (props) => {
//     const { name, accept, multiple, formik, error, errorMessage } = props;
...
//             dataTransfer.items.add(filteredFile),
//         );
//         inputFileRef.current.files = dataTransfer.files;
//         formik.setFieldValue(name, filteredFiles);
//     };
...
//     const removeFile = (indexToDelete) => {
//         const filteredFiles = Array.from(inputFileRef.current.files).filter(
...
//         );
//         refreshFiles(selectedFiles.slice(0, multiple ? selectedFiles.length : 1));
//     };
